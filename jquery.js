!(function (e, t) {
            ...
            if (!i && (p(t), (t = t || d), g)) {
                ...
                if (n.qsa && !S[e + " "] && (!v || !v.test(e)) && (1 !== b || "object" !== t.nodeName.toLowerCase())) {
                    if (((m = e), (y = t), 1 === b && (X.test(e) || z.test(e)))) {
                        for (((y = (ee.test(e) && ey(t.parentNode)) || t) === t && n.scope) || ((c = t.getAttribute("id")) ? (c = c.replace(er, ei)) : t.setAttribute("id", (c = x))), s = (h = a(e)).length; s--; )
                            h[s] = (c ? "#" + c : ":scope") + " " + ex(h[s]);
                        m = h.join(",");
                    }
                    try {
                    ...
                    (n.qsa = J.test(d.querySelectorAll)) &&
                        (ef(function (e) {
                            ...
                            (h.appendChild(e).innerHTML = "<a id='" + x + "'></a><select id='" + x + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                ...
                                e.appendChild(t),
                                e.querySelectorAll("[name='']").length || v.push("\\[" + O + "*name" + O + "*=" + O + "*(?:''|\"\")"),
                    ...
                    (v = k(
                        ...
                        (c = function (e, t, n, a, c) {
                            ...
                            if (((m += y), s && y !== m)) {
                                ...
                                if (e) {
                                    if (0 < m) for (; y--; ) $[y] || x[y] || (x[y] = A.call(a));
                                    x = ew(x);
                                }
                        ...
                        s &&
                            ...
                            (function t(n) {
                                b.each(n, function (n, r) {
                                    h(r) ? (e.unique && f.has(r)) || s.push(r) : r && r.length && "string" !== $(r) && t(r);
                                });
                            })(arguments),
                            i && !r && c()),
                        this
                                        ...
                                        c = i
                                            ...
                                            : function () {
                                                  try {
                                                      ...
                                                      b.Deferred.exceptionHook && b.Deferred.exceptionHook(e, c.stackTrace), o <= t + 1 && (r !== O && ((s = void 0), (u = [e])), n.rejectWith(s, u));
                                                  }
                                              };
    ...
    var R = function (e, t, n, r, i, o, a) {
            var s = 0,
                u = e.length,
                l = null == n;
            if ("object" === $(n)) for (s in ((i = !0), n)) R(e, t, s, n[s], !0, o, a);
            else if (
                void 0 !== r &&
                ((i = !0),
                h(r) || (a = !0),
                    ...
                    ? ("none" === n && ((l[c] = Y.get(r, "display") || null), l[c] || (r.style.display = "")),
                      "" === r.style.display &&
                          ...
                          (l[c] =
                              ((u = a = o = void 0),
                              (a = (i = r).ownerDocument),
                              (u = eu[(s = i.nodeName)]) || ((o = a.body.appendChild(a.createElement(s))), (u = b.css(o, "display")), o.parentNode.removeChild(o), "none" === u && (u = "block"), (eu[s] = u)))))
    ...
    function e$(e, t, n, r, i) {
        ...
        for (f.textContent = "", d = 0; (o = p[d++]); )
            ...
            else if (((l = ei(o)), (a = ev(f.appendChild(o), "script")), l && em(a), n)) for (c = 0; (o = a[c++]); ) eh.test(o.type || "") && n.push(o);
        return f;
    }
    var ex = /^key/,
    ...
    function ek(e, t, n, r, i, o) {
        var a, s;
        if ("object" == typeof t) {
            for (s in ("string" != typeof n && ((r = r || n), (n = void 0)), t)) ek(e, s, n, r, t[s], o);
            return e;
        }
    ...
    function eS(e, t, n) {
        n
            ...
            : void 0 === Y.get(e, t) && b.event.add(e, t, ew);
    }
    (b.event = {
        global: {},
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(H) || [""]).length; l--; )
                    if (((d = g = (s = e_.exec(t[l]) || [])[1]), (h = (s[2] || "").split(".").sort()), d)) {
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return ep.test(t.type) && t.click && S(t, "input") && eS(t, "click", ew), !1;
                },
                trigger: function (e) {
                    var t = this || e;
                    return ep.test(t.type) && t.click && S(t, "input") && eS(t, "click"), !0;
                },
                _default: function (e) {
                    var t = e.target;
        ...
        (b.Event = function (e, t) {
            ...
            e && e.type
                ? ((this.originalEvent = e),
                  (this.type = e.type),
                  (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? ew : eT),
        ...
        b.each(
            {
                ...
                which: function (e) {
                    var t = e.button;
                    return null == e.which && ex.test(e.type) ? (null != e.charCode ? e.charCode : e.keyCode) : !e.which && void 0 !== t && eb.test(e.type) ? (1 & t ? 1 : 2 & t ? 3 : 4 & t ? 2 : 0) : e.which;
                },
            },
            b.event.addProp
        ),
    ...
    function eH(e, t, n, r) {
        ...
        var i,
            ...
            v = t[0],
            m = h(v);
        if (m || (1 < p && "string" == typeof v && !d.checkClone && eN.test(v)))
            return e.each(function (i) {
                var o = e.eq(i);
                m && (t[0] = v.call(this, i, o.html())), eH(o, t, n, r);
            });
        if (p && ((a = (i = e$(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === i.childNodes.length && (i = a), a || r)) {
            for (u = (s = b.map(ev(i, "script"), ej)).length; f < p; f++) (l = i), f !== g && ((l = b.clone(l, !0, !0)), u && b.merge(s, ev(l, "script"))), n.call(e[f], l, f);
            if (u)
                for (c = s[s.length - 1].ownerDocument, b.map(s, eq), f = 0; f < u; f++)
                    (l = s[f]),
                        eh.test(l.type || "") &&
                            !Y.access(l, "globalEval") &&
                            b.contains(c, l) &&
                            (l.src && "module" !== (l.type || "").toLowerCase() ? b._evalUrl && !l.noModule && b._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, c) : y(l.textContent.replace(eD, ""), l, c));
        }
        return e;
    }
    function eP(e, t, n) {
    ...
    b.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t) {
                if (n) for (o = o || ev(e), a = a || ev(c), r = 0, i = o.length; r < i; r++) eL(o[r], a[r]);
                else eL(e, c);
            }
            ...
            html: function (e) {
                return R(
                    ...
                    function (e) {
                        ...
                        if ("string" == typeof e && !eE.test(e) && !eg[(ed.exec(e) || ["", ""])[1].toLowerCase()]) {
                            e = b.htmlPrefilter(e);
                            try {
    ...
    function eW(e, t, n) {
        ...
        return (
            (n = n || e0(e)) &&
                ...
                !d.pixelBoxStyles() && eO.test(a) && eM.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o))),
            void 0 !== a ? a + "" : a
        );
    }
    function e1(e, t) {
                ...
                reliableTrDimensions: function () {
                    ...
                    return (
                        null == s &&
                            ...
                            (s = 3 < parseInt((i = e.getComputedStyle(n)).height)),
                            er.removeChild(t)),
                        s
                    );
                },
    ...
    function eF(e) {
        return (
            ...
            (e in e9
                ...
                : (eR[e] =
                      (function (e) {
                          for (var t = e[0].toUpperCase() + e.slice(1), n = eB.length; n--; ) if ((e = eB[n] + t) in e9) return e;
                      })(e) || e))
        );
    }
    var e8 = /^(none|table(?!-c[ea]).+)/,
        ez = /^--/,
        e2 = { position: "absolute", visibility: "hidden", display: "block" },
    ...
    function e4(e, t, n) {
        ...
        return (
            ...
            (a = parseFloat(a) || 0) + eU(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
        );
    }
    ...
    b.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i,
                    ...
                    u = ez.test(t),
                    l = e.style;
                if ((u || (t = eF(s)), (a = b.cssHooks[t] || b.cssHooks[s]), void 0 === n)) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
        ...
        b.each(["height", "width"], function (e, t) {
            b.cssHooks[t] = {
                get: function (e, n, r) {
                    if (n)
                        return !e8.test(b.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
                            ? e4(e, t, r)
                            : eI(e, e2, function () {
                                  return e4(e, t, r);
                              });
                ...
                set: function (e, n, r) {
                    var i,
                        ...
                        u = r ? eU(e, t, r, s, o) : 0;
                    return (
                        s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - eU(e, t, "border", !1, o) - 0.5)),
        ...
        b.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
            (b.cssHooks[e + t] = {
                ...
                "margin" !== e && (b.cssHooks[e + t].set = e3);
        }),
        b.fn.extend({
            css: function (e, t) {
                return R(
                    ...
                    function (e, t, n) {
                        var r,
                            ...
                            a = 0;
                        if (Array.isArray(t)) {
                            for (r = e0(e), i = t.length; a < i; a++) o[t[a]] = b.css(e, t[a], !1, r);
                            return o;
                        }
        ...
        ((e7.propHooks = {
            _default: {
                ...
                set: function (e) {
                    b.fx.step[e.prop] ? b.fx.step[e.prop](e) : 1 === e.elem.nodeType && (b.cssHooks[e.prop] || null != e.elem.style[eF(e.prop)]) ? b.style(e.elem, e.prop, e.now + e.unit) : (e.elem[e.prop] = e.now);
                },
            },
    ...
    function eZ(e, t, n) {
        for (var r, i = (te.tweeners[t] || []).concat(te.tweeners["*"]), o = 0, a = i.length; o < a; o++) if ((r = i[o].call(n, t, e))) return r;
    }
    function te(e, t, n) {
        var r,
            i,
            ...
            u = function () {
                if (i) return !1;
                for (var t = eV || e5(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length; o < a; o++) l.tweens[o].run(r);
    ...
    (b.Animation = b.extend(te, {
            ...
            function (e, t, n) {
                ...
                if ((u = !b.isEmptyObject(t)) || !b.isEmptyObject(d))
                    for (r in (f &&
                        ...
                        "none" === (c = b.css(e, "display")) && (l ? (c = l) : (el([e], !0), (l = e.style.display || l), (c = b.css(e, "display")), el([e]))),
            ...
            stop: function (e, t, n) {
                ...
                return (
                    ...
                    this.each(function () {
                        ...
                        else for (i in a) a[i] && a[i].stop && eK.test(i) && r(a[i]);
        ...
        b.each({ slideDown: eJ("show"), slideUp: eJ("hide"), slideToggle: eJ("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
        ...
        (b.fx.start = function () {
            eG ||
                ((eG = !0),
                (function t() {
                    eG && (!1 === v.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(t) : e.setTimeout(t, b.fx.interval), b.fx.tick());
                })());
        }),
        (b.fx.stop = function () {
            eG = null;
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? b.prop(e, t, n)
                        : ((1 === o && b.isXMLDoc(e)) || (i = b.attrHooks[t.toLowerCase()] || (b.expr.match.bool.test(t) ? tt : void 0)),
                          void 0 !== n
                              ? null === n
        ...
        b.each(b.expr.match.bool.source.match(/\w+/g), function (e, t) {
            ...
            tn[t] = function (e, t, r) {
                var i,
                    o,
                    a = t.toLowerCase();
                return r || ((o = tn[a]), (tn[a] = i), (i = null != n(e, t, r) ? a : null), (tn[a] = o)), i;
            };
        });
    ...
    b.fn.extend({
            ...
            propHooks: {
                tabIndex: {
                    get: function (e) {
                        ...
                        return t ? parseInt(t, 10) : tr.test(e.nodeName) || (ti.test(e.nodeName) && e.href) ? 0 : -1;
                    },
                },
            },
        ...
        b.fn.extend({
            addClass: function (e) {
                ...
                if (h(e))
                    return this.each(function (t) {
                        b(this).addClass(e.call(this, t, ta(this)));
                    });
                if ((t = ts(e)).length) {
                    for (; (n = this[u++]); )
                        if (((i = ta(n)), (r = 1 === n.nodeType && " " + to(i) + " "))) {
                            for (a = 0; (o = t[a++]); ) 0 > r.indexOf(" " + o + " ") && (r += o + " ");
                            i !== (s = to(r)) && n.setAttribute("class", s);
                        }
                }
                return this;
            },
            removeClass: function (e) {
                ...
                if (h(e))
                    return this.each(function (t) {
                        b(this).removeClass(e.call(this, t, ta(this)));
                    });
            ...
            toggleClass: function (e, t) {
                ...
                return "boolean" == typeof t && r
                    ...
                    ? this.each(function (n) {
                          b(this).toggleClass(e.call(this, n, ta(this), t), t);
                      })
                    : this.each(function () {
                          var t, i, o, a;
                          if (r) for (i = 0, o = b(this), a = ts(e); (t = a[i++]); ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
            ...
            hasClass: function (e) {
                var t,
                    n,
                    r = 0;
                for (t = " " + e + " "; (n = this[r++]); ) if (1 === n.nodeType && -1 < (" " + to(ta(n)) + " ").indexOf(t)) return !0;
                return !1;
            },
        });
    var tu = /\r/g;
    ...
    b.extend(b.event, {
        trigger: function (t, n, r, i) {
            ...
            if (
                ...
                if (!i && !p.noBubble && !g(r)) {
                    for (u = p.delegateType || y, tl.test(u + y) || (a = a.parentNode); a; a = a.parentNode) m.push(a), (s = a);
    ...
    function ty(e, t, n, r) {
        ...
        if (Array.isArray(t))
            b.each(t, function (t, i) {
                n || th.test(e) ? r(e, i) : ty(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r);
            });
        ...
        b.fn.extend({
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    .filter(function () {
                        var e = this.type;
                        return this.name && !b(this).is(":disabled") && tm.test(this.nodeName) && !tv.test(e) && (this.checked || !ep.test(e));
                    })
                    .map(function (e, t) {
                        var n = b(this).val();
                        return null == n
    ...
    (tE.href = tf.href),
        b.extend({
            ...
            ajax: function (t, n) {
                ...
                var r,
                    ...
                    T = {
                        ...
                        getResponseHeader: function (e) {
                            var t;
                            if (l) {
                                if (!a) for (a = {}; (t = t_.exec(o)); ) a[t[1].toLowerCase() + " "] = (a[t[1].toLowerCase() + " "] || []).concat(t[2]);
                                t = a[e.toLowerCase() + " "];
                            }
                ...
                if (
                    (m.promise(T),
                    (d.url = ((t || d.url || tf.href) + "").replace(tT, tf.protocol + "//")),
                    ...
                    u = v.createElement("a");
                    try {
                        (u.href = d.url), (u.href = u.href), (d.crossDomain = tE.protocol + "//" + tE.host != u.protocol + "//" + u.host);
                    } catch (C) {
                        d.crossDomain = !0;
                    }
                }
                if ((d.data && d.processData && "string" != typeof d.data && (d.data = b.param(d.data, d.traditional)), tD(tC, d, n, T), l)) return T;
                for (f in ((c = b.event && d.global) && 0 == b.active++ && b.event.trigger("ajaxStart"),
                (d.type = d.type.toUpperCase()),
                (d.hasContent = !tw.test(d.type)),
                (i = d.url.replace(tx, "")),
                d.hasContent
                    ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(t$, "+"))
                    : ((p = d.url.slice(i.length)),
                      d.data && (d.processData || "string" == typeof d.data) && ((i += (td.test(i) ? "&" : "?") + d.data), delete d.data),
                      !1 === d.cache && ((i = i.replace(tb, "$1")), (p = (td.test(i) ? "&" : "?") + "_=" + tp.guid++ + p)),
                      (d.url = i + p)),
                d.ifModified && (b.lastModified[i] && T.setRequestHeader("If-Modified-Since", b.lastModified[i]), b.etag[i] && T.setRequestHeader("If-None-Match", b.etag[i])),
                ((d.data && d.hasContent && !1 !== d.contentType) || n.contentType) && T.setRequestHeader("Content-Type", d.contentType),
                T.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + tS + "; q=0.01" : "") : d.accepts["*"]),
                d.headers))
                    T.setRequestHeader(f, d.headers[f]);
                if (d.beforeSend && (!1 === d.beforeSend.call(h, T, d) || l)) return T.abort();
                if (((w = "abort"), y.add(d.complete), T.done(d.success), T.fail(d.error), (r = tD(tk, d, n, T)))) {
                ...
                function S(t, n, a, u) {
                    ...
                    l ||
                        ...
                        !f && -1 < b.inArray("script", d.dataTypes) && (d.converters["text script"] = function () {}),
                        (x = (function (e, t, n, r) {
                            var i,
                                o,
                                a,
                        ...
                        f
                            ? (d.ifModified && ((_ = T.getResponseHeader("Last-Modified")) && (b.lastModified[i] = _), (_ = T.getResponseHeader("etag")) && (b.etag[i] = _)),
                              204 === t || "HEAD" === d.type ? (w = "nocontent") : 304 === t ? (w = "notmodified") : ((w = x.state), (p = x.data), (f = !(v = x.error))))
                        ...
                        y.fireWith(h, [T, w]),
                        c && (g.trigger("ajaxComplete", [T, d]), --b.active || b.event.trigger("ajaxStop")));
                }
                return T;
            },
                            ...
                            return function () {
                                n &&
                                    ...
                                    "abort" === e
                                        ...
                                        : o(tj[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? { binary: s.response } : { text: s.responseText }, s.getAllResponseHeaders()));
                            };
                        }),
                            (s.onload = n()),
    ...
    b.ajaxSetup({
        ...
        b.ajaxPrefilter("json jsonp", function (t, n, r) {
            var i,
                o,
                a,
                s = !1 !== t.jsonp && (tP.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && tP.test(t.data) && "data");
            if (s || "jsonp" === t.dataTypes[0])
                return (
                    (i = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
                    s ? (t[s] = t[s].replace(tP, "$1" + i)) : !1 !== t.jsonp && (t.url += (td.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
                    ...
                    r.always(function () {
                        void 0 === o ? b(e).removeProp(i) : (e[i] = o), t[i] && ((t.jsonpCallback = n.jsonpCallback), tH.push(i)), a && h(o) && o(a[0]), (a = o = void 0);
                    }),
                    "script"
                );
        }),
        (d.createHTMLDocument = (((tL = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === tL.childNodes.length)),
        (b.parseHTML = function (e, t, n) {
            ...
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  (o = !n && []),
                  (i = E.exec(e)) ? [t.createElement(i[1])] : ((i = e$([e], t, o)), o && o.length && b(o).remove(), b.merge([], i.childNodes)));
        }),
        (b.fn.load = function (e, t, n) {
            var r,
                ...
                s = e.indexOf(" ");
            return (
                -1 < s && ((r = to(e.slice(s))), (e = e.slice(0, s))),
        ...
        b.each(["top", "left"], function (e, t) {
            b.cssHooks[t] = e1(d.pixelPosition, function (e, n) {
                if (n) return (n = eW(e, t)), eO.test(n) ? b(e).position()[t] + "px" : n;
            });
        }),
